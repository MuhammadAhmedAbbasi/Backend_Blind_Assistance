...
#     input_video_path = r"D:\backend_algorithm_blind_person_guidance\testing_video_part\testing_video.mp4"  # Replace with your video path
#     output_video_path = r"D:\backend_algorithm_blind_person_guidance\testing_video_part\output_video_with_detections.mp4"  # Output video path
...
#     # Path to your image
#     image_path = r"D:\backend_algorithm_blind_person_guidance\other_materials\gaojinwei2.jpg"  # Change this to your image path
...
#     # Process image
#     processed_frame, depth_vis, outside_vicinity, inside_vicinity = detector.process_frame(image)
#     print(f'The Inside vicinity people ar: {inside_vicinity}')
#     print(f'The outside vicinity people ar: {outside_vicinity}')
